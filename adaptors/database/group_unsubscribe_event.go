...
func (e *GroupUnsubscribeEvent) MapEvent(eventMap map[string]interface{}) {
...
func (e *GroupUnsubscribeEvent) Save(adaptor *Adaptor) error {
	groupUnsubscribeTable := adaptor.Session.Table("group_unsubscribe_events", &GroupUnsubscribeEvent{}, gocassa.Keys{
		PartitionKeys: []string{"sg_event_id"},
	})

	if err := groupUnsubscribeTable.Set(e).Run(); err != nil {
